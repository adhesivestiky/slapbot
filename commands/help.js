...
module.exports.run = async (bot, message, args) => {
  ...
  .addField("\`.info\`", "Displays some information about the bot")
  .addField("\`.userinfo [user]\`", "Displays some basic information about the given user.")
  .addField("\`.up\`", "Displays the bot's uptime")
  ...
  .addField("\`.shop\`", "Displays the list of all purchasable items!")
  .addField("\`.explode [user]\`", "Takes away a bit of a user's health.")
